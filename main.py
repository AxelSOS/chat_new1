...
class Chat:
        ...
        while True:
            try:
                ...
                if msg_to_send.lower() == "quit":
                    ...
                    # decrypt the message
                    decrypted_msg = self.f.decrypt(bytes(msg, 'utf-8'))
                    self.client.publish(self.topic, decrypted_msg)

                    # Publish a message that the user has left the chat room
                ...
                # and publish it
                self.client.publish(self.topic, message_to_send)
    ...
    def gen_crypt_key(passphrase: str):
        return base64.urlsafe_b64decode(bytes("my32lenghtsupersecretnooneknows1", 'uft-8'))


def main():
    # Init application. Ask for username and chat room
    username = input("Enter your username: ")
    msg_key = base64.urlsafe_b64decode(bytes("my32lenghtsupersecretnooneknows1", 'utf-8'))
